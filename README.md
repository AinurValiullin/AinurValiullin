...
Тестирование REST API (CRUD, статус-коды, валидация)
Работа с Postman (коллекции, environment, автотесты)
Документация API через Swagger / OpenAPI
Базовое понимание SOAP
Тестирование асинхронных систем (Kafka)
Работа с Docker (поднятие сервисов)
