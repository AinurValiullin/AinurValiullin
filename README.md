## Привет！ 👋
Меня зовут Айнур, я Junior QA Engineer с фокусом на manual и API тестировании.

Имею базовые навыки в тест-дизайне, составлении тест-кейсов и баг-репортов, а также работе с REST API (Postman) и SQL.

Открыт к возможностям и стремлюсь развиваться в сфере обеспечения качества ПО.
